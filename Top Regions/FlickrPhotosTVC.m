...
@property  (nonatomic, strong) NSMutableArray *latestPhotoList;
...
- (NSArray *)latestPhotoList
{
    if (!_latestPhotoList) _latestPhotoList = [[NSMutableArray alloc]init];
    return _latestPhotoList;
}
...
- (void)prepareImageViewController:(ImageViewController *)ivc toDisplayPhoto:(NSDictionary *)photo
{
    ...
    // save information about this photo to our list of most recent photos
    [self.latestPhotoList insertObject:photo atIndex:0];
}
